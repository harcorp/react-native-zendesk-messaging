...
export const listenUnreadMessageCountChanged = (
  onChange: (count: number) => void
) => {
  eventEmitter.addListener('unreadMessageCountChanged', (count) => {
    onChange(count);
  });
  return () => eventEmitter.removeAllListeners('unreadMessageCountChanged');
};
